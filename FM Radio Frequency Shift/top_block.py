...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Frequency_Shift = Frequency_Shift = 20000
        self.FM_station = FM_station = 97400000
        ...
        self.qtgui_number_sink_0.set_title('if 1  then stereo ; else mono')
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff((-25), (-25), 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\monic\\OneDrive\\Ambiente de Trabalho\\Projetos\\My Projects\\My-Projects\\FM Radio Frequency Shift\\IQ_104,3MHz.dat', True, 0, 0)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, Frequency_Shift, 1, 0, 0)
        ...
        self.connect((self.band_pass_filter_1, 0), (self.logpwrfft_x_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_2, 0), (self.audio_sink_0, 1))
        self.connect((self.blocks_multiply_xx_3, 0), (self.audio_sink_0, 0))
        ...
        self.connect((self.high_pass_filter_0, 0), (self.blocks_multiply_xx_1, 1))
        ...
        self.connect((self.low_pass_filter_2, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.rational_resampler_xxx_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.rational_resampler_xxx_1, 0), (self.blocks_multiply_xx_3, 0))
        self.connect((self.rational_resampler_xxx_1_0, 0), (self.blocks_multiply_xx_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, (self.samp_rate/16), 23000, 53000, 100, window.WIN_HAMMING, 6.76))
        self.band_pass_filter_1.set_taps(firdes.band_pass(6, (self.samp_rate/16), 18900, 19100, 100, window.WIN_HAMMING, 6.76))
        self.high_pass_filter_0.set_taps(firdes.high_pass(9, (self.samp_rate/16), 37500, 100, window.WIN_HAMMING, 6.76))
        self.logpwrfft_x_0.set_sample_rate((self.samp_rate/16))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, (self.samp_rate/16), 15000, 100, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_2.set_taps(firdes.low_pass(11, (self.samp_rate/16), 15000, 100, window.WIN_HAMMING, 6.76))
    ...
    def set_Frequency_Shift(self, Frequency_Shift):
        ...
        self.analog_sig_source_x_0.set_frequency(self.Frequency_Shift)
